            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                >
                    <div class="flex-col space-y-2 overflow-x-auto">
                        ...
                        @include('components.grl.tableComponents.designone.faq.faq-table-components')
    
                        <div class="md:space-x-1 p-2 w-full">
                            @include('components.grl.tableComponents.designone.faq.faq-table')
                            <div class="mt-2 mb-2 w-full overflow-y-auto">
                                {{ $faqs->links() }}
                            </div>
                            @include('components.grl.tableComponents.designone.faq.faq-table-modal')
                        </div>
