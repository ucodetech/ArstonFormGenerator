<div>
    <form wire:submit="register">
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model.blur="email" id="email" class="block mt-1 w-full" type="email" name="email"  autocomplete="username"  />
        ...
        <div class="mt-4">
            ...
            <x-text-input wire:model.blur="password" id="password" class="block mt-1 w-full"
                            type="password"
                            name="password"
