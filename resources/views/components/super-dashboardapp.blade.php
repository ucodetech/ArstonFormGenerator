    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                        <img
                            ...
                            class="mr-3 h-8"
                            alt="fpinewsline Logo"
                        />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FPINL Admin</span>
                    </a>
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <!-- Notifications -->
                        @include('livewire.users.admin.inc.notification')
                    <!-- Apps Dropdown -->
                        @include('livewire.users.admin.inc.apps-dropdown')
                    <!-- Profile Menu -->
                        @include('livewire.users.admin.inc.profile-menu')
                </div>
            </div>
        </nav>
        <!-- Sidebar -->
        ...
        >
            <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                <!-- Search Form -->
                @include('livewire.users.admin.inc.search-form')
                <!-- Navbar -->
                {{-- @include('livewire.inc.supernav') --}}
                <livewire:inc.supernav>
        ...
        @php
            ...
            if (str_contains($title, '-')){
               ...
               $title4 = ucfirst($title2[1]);
            }else{
                $title4 = ucfirst($title);
            }
        @endphp
        <div class="mb-0 pt-32 pl-2 md:pt-20 md:ml-64 md:pl-4 pb-4 bg-gray-800">
            Superuser {{ $title4 }}
        </div>
        {{ $slot }}
    </div>
