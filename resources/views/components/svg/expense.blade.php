<svg {{ $attributes }} xmlns="http://www.w3.org/2000/svg" fill="#e21b1b" stroke="#e21b1b" class="jam jam-arrow-square-up-f" preserveAspectRatio="xMinYMin" viewBox="-2 -2 24 24">
