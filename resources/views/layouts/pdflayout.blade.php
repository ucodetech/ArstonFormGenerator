...
<head lang="en">
    ...
    <body class="dark  h-auto">
        <div class="relative bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white p-0 flex justify-center">
